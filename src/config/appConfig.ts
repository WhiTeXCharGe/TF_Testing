...
// Scheduler Webapp origin — used to consume a cross-app handoff
// (?incomingTransfer=<token>) sent via 結果を表示 / コピーファイル表示.
export const SCHEDULER_WEB_URL = 'http://localhost:5174';
