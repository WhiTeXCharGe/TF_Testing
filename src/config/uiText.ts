...
export const UI = {
  ...
  phaseEndDateRequiredLabel: '終了希望日 *',
  ...
  sessionCreateTab: '新規作成',
  sessionListRefreshBtn: '更新',
  sessionListEmpty: 'オンラインセッションはありません',
  sessionListOpenBtn: '開く',
