...
static class OpTaskMeta {
    ...
    public boolean isPinned() {
        // Warm-start only (NOT pinned). Stage1 will still start from initial values,
        // but the solver may move them immediately if it improves the score.
        return false;
    }
}
...
// Computed candidates (filled once per solve stage)
    ...
    public static class SinglePassConstraints implements ConstraintProvider {
        ...
        static final int COMPANY_PAIR_W    = 50;
